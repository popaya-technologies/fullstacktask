...
app.get("/users", (req, res) => {
  ...
  //res.send(userList);  //cause an error as there is nothing like userList
  res.send(allUsers);
});
...
async function fetchExternalData(){
  console.log({message:"This is testing for Data",status:"success"})
}
